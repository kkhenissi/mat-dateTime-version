...
import { OutputFileComponent } from 'app/entities/output-file/output-file.component';
...
describe('Component Tests', () => {
  describe('OutputFile Management Component', () => {
    let comp: OutputFileComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OutputFileComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.outputFiles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
