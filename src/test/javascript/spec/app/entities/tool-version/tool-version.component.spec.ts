...
import { ToolVersionComponent } from 'app/entities/tool-version/tool-version.component';
...
describe('Component Tests', () => {
  describe('ToolVersion Management Component', () => {
    let comp: ToolVersionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ToolVersionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.toolVersions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
