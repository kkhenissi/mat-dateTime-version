...
public class UserResourceIT {
    ...
    public static User createOwner(EntityManager em, UserRepository userRepository, UserService userService){
        User user = createEntity(em);
        userRepository.saveAndFlush(user);
        SecurityContext securityContext = SecurityContextHolder.createEmptyContext();
        securityContext.setAuthentication(new UsernamePasswordAuthenticationToken(user.getLogin(), "admin"));
        SecurityContextHolder.setContext(securityContext);
        Optional<String> login = SecurityUtils.getCurrentUserLogin();
        User owner = userService.getUserWithAuthoritiesByLogin(login.get()).get();
        return owner;
    }
