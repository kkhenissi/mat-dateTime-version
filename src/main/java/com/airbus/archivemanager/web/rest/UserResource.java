...
import com.airbus.archivemanager.web.rest.errors.EmailAlreadyUsedException;
import com.airbus.archivemanager.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody UserDTO userDTO) throws URISyntaxException {
        log.info("REST request to save User with login : {}", userDTO.getLogin());
    ...
    public ResponseEntity<UserDTO> updateUser(@Valid @RequestBody UserDTO userDTO) {
        log.info("REST request to update User with id : {}", userDTO.getId());
    ...
    public List<String> getAuthorities() {
        log.info("REST request to get a page of Authorities");
    ...
    public ResponseEntity<UserDTO> getUser(@PathVariable String login) {
        log.info("REST request to get User with login : {}", login);
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable String login) {
        log.info("REST request to delete User with login: {}", login);
