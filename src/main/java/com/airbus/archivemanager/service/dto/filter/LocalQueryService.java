...
public abstract class LocalQueryService<ENTITY> {
    ...
    protected <X> Specification<ENTITY> buildLocalSpecification(LocalFilter<X> filter, SingularAttribute<? super ENTITY, X>
        field) {
        return buildLocalSpecification(filter, root -> root.get(field));
    }
    ...
    protected <X> Specification<ENTITY> buildLocalSpecification(LocalFilter<X> filter, Function<Root<ENTITY>, Expression<X>> metaclassFunction) {
        if (filter.getEquals() != null) {
            return equalsSpecification(metaclassFunction, filter.getEquals());
        } else if (filter.getSpecified() != null) {
            return byFieldSpecified(metaclassFunction, filter.getSpecified());
     ...
     * @return a Specification
     */
    protected <X extends Comparable<? super X>> Specification<ENTITY> buildRangeSpecification(io.github.jhipster.service.filter.RangeFilter<X> filter,
                                                                                              SingularAttribute<? super ENTITY, X> field) {
        return buildSpecification(filter, root -> root.get(field));
    }

    protected <X extends Comparable<? super X>> Specification<ENTITY> buildLocalRangeSpecification(LocalRangeFilter<X> filter,
                                                                                                   SingularAttribute<? super ENTITY, X> field) {
        return buildLocalSpecification(filter, root -> root.get(field));
    }
     ...
     * @return a Specification
     */
    protected <X extends Comparable<? super X>> Specification<ENTITY> buildLocalSpecification(LocalRangeFilter<X> filter,
    ...
    protected <X extends Comparable<? super X>> Specification<ENTITY> buildSpecification(io.github.jhipster.service.filter.RangeFilter<X> filter,
                                                                                         Function<Root<ENTITY>, Expression<X>> metaclassFunction) {
        if (filter.getEquals() != null) {
            return equalsSpecification(metaclassFunction, filter.getEquals());
        } else if (filter.getIn() != null) {
     ...
     * @return a Specification
     */
    protected <OTHER, X> Specification<ENTITY> buildReferringEntitySpecification(LocalFilter<X> filter,
                                                                                 SingularAttribute<? super ENTITY, OTHER> reference,
                                                                                 SingularAttribute<? super OTHER, X> valueField) {
        return buildLocalSpecification(filter, root -> root.get(reference).get(valueField));
    }
     ...
     * @return a Specification
     */
    protected <OTHER, MISC, X> Specification<ENTITY> buildReferringEntitySpecification(LocalFilter<X> filter,
     ...
     * @return a Specification
     */
    protected <OTHER, X extends Comparable<? super X>> Specification<ENTITY> buildReferringEntitySpecification(final LocalRangeFilter<X> filter,
     ...
     * @return a Specification
     */
    protected <OTHER, MISC, X extends Comparable<? super X>> Specification<ENTITY> buildReferringEntitySpecification(final LocalRangeFilter<X> filter,
                                                                                                                     Function<Root<ENTITY>, SetJoin<MISC, OTHER>> functionToEntity,
                                                                                                                     Function<SetJoin<MISC, OTHER>, Expression<X>> entityToColumn) {
    ...
    protected <OTHER, MISC, X extends Comparable<? super X>> Specification<ENTITY> buildReferringEntitySpecification(final io.github.jhipster.service.filter.RangeFilter<X> filter,
                                                                                                                     Function<Root<ENTITY>, SetJoin<MISC, OTHER>> functionToEntity,
                                                                                                                     Function<SetJoin<MISC, OTHER>, Expression<X>> entityToColumn) {
