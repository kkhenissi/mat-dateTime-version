...
/**
 * Criteria class for the {@link com.airbus.archivemanager.domain.ConfigDataSet} entity. This class is used
 * in {@link com.airbus.archivemanager.web.rest.ConfigDataSetResource} to receive all the possible filtering options from
 ...
 */
public class ConfigDataSetCriteria implements Serializable, Criteria {
    private static final long serialVersionUID = 1L;
    private LongFilter id;
    private StringFilter name;


    public ConfigDataSetCriteria() {
    }

    public ConfigDataSetCriteria(ConfigDataSetCriteria other) {
        this.id = other.id == null ? null : other.id.copy();
        this.name = other.name == null ? null : other.name.copy();
    }

    @Override
    public ConfigDataSetCriteria copy() {
        return new ConfigDataSetCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ConfigDataSetCriteria that = (ConfigDataSetCriteria) o;
        return
