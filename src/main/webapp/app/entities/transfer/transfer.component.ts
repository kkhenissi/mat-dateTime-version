...
export class TransferComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.transferService
      ...
      .subscribe(
        (res: HttpResponse<ITransfer[]>) => this.paginateTransfers(res.body, res.headers),
  ...
  trackId(index: number, item: ITransfer) {
    return item.id;
  }
  ...
  protected paginateTransfers(data: ITransfer[], headers: HttpHeaders) {
